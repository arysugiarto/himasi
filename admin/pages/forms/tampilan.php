                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <div class="box-body pad">
                                <form action="tampilan_proses.php" method="post" enctype="multipart/form-data">
                                    <table>
                                        <br>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <label>Nama Universitas</label>
                                             <input  class="form-control" type="text" name="univ" size="150" placeholder="Judul Artikel/Berita" ></td>
                                        </tr>
                                    </table>
                                        <br>
                                        <textarea id="summernote" name="font" rows="10" cols="80"></textarea>
                                        <br>
