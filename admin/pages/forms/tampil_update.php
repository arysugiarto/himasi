            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <?php
                        $lihat = mysqli_query($link,"SELECT * FROM post WHERE Id={$id}");
                        ?>
                        <div class="box-body pad">
                            <form action="update.php" method="post" enctype="multipart/form-data">
                                ...
                                <table>
                                    ...
                                    <td> <input  class="form-control" type="text" name="judul" size="150" placeholder="Judul Artikel/Berita" value="<?php echo $data["Judul"]; ?>" ></td>
                                    </tr>
                                    <br>
                                    <tr>
                                        <td>
                                ...
                                <br>
                                <textarea id="summernote" name="editor" rows="10" cols="80">
