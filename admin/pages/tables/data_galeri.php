...
if (isset($_SESSION['username'])) {
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            ?>
            <?php $tampil_galeri=mysqli_query($link,"SELECT * FROM tb_galeri "); ?>
            <!-- Main content -->
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    while ($data_galeri=mysqli_fetch_array($tampil_galeri)){
                                        ...
                                        <tr>
                                            ...
                                            <td><img width="100" height="75" src="../forms/img/img_galeri/<?php echo $data_galeri['gambar_galeri']?>"></td>
                                            <td>
                                                <a href="galeri-update.php?id=<?=$data_galeri['id_galeri']?>"><button class="btn btn-info btn-sm"><i class="glyphicon glyphicon-edit"></i> Edit</button></a>
                                                <a href="delete_galeri.php?id_galeri=<?=$data_galeri['id_galeri']?>"><button class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> Hapus</button></a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    <?php } ?>
