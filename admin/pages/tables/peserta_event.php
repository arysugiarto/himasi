...
<!-- User Account: style can be found in dropdown.less -->
 <li class="dropdown user user-menu">
        ...
        <div class="content-wrapper">
            ...
            ?>
            <?php $tampil_event=mysqli_query($link,"SELECT tb_dafevent.nama, tb_dafevent.kelas, tb_dafevent.asal_sekolah, tb_dafevent.email, tb_dafevent.jurusan, tb_event.id_event FROM tb_dafevent JOIN tb_event ON tb_dafevent.id_event=tb_event.id_event WHERE tb_event.id_event='$id' "); ?>
            <!-- Main content -->
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    while ($data_event=mysqli_fetch_array($tampil_event)){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $data_event['nama']?></td>
                                            <td><?php echo $data_event['kelas'] ?></td>
                                            <td><?php echo $data_event['asal_sekolah'] ?></td>
                                            <td><?php echo $data_event['email'] ?></td>
                                            <td><?php echo $data_event['jurusan'] ?></td>
                                            <td>
