                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <?php $tampil_artikel = mysqli_query($link,"SELECT * FROM tb_artikel WHERE id='$id' "); ?>
                            <!-- /.box-header -->
                            <div class="box-body pad">
                                <form action="proses.php" method="post" enctype="multipart/form-data">
                                    <?php
                                    while ($data = mysqli_fetch_array($tampil_artikel)){
                                    ?>
                                    <table>
                                        <tr>
                                            <td> <input  class="form-control" type="text" name="judul" size="150" placeholder="Judul Artikel/Berita" value="<?php echo $data['judul_artikel']?>" ></td>
                                        </tr>
                                        <br>
                                        <tr>
                                            <td>
