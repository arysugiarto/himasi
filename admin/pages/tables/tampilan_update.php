    ...
    ?>
        ...
        <div class="wrapper">
                ...
                <section class="sidebar">
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="form_kesan.php"><i class="fa fa-circle-o"></i>Post Kesan</a></li>
            ...
            <div class="content-wrapper">
                ...
                <?php $tampil_tampilan=mysqli_query($link,"SELECT * FROM tb_tampilan WHERE id_tampilan='$id'"); ?>
                <!-- Main content -->
                        ...
                        <div class="col-md-12">
                            <div class="box box-info">
                                ...
                                <div class="box-body pad">
                                    <form action="update_tampilan.php" method="post" enctype="multipart/form-data">
                                        <table>
                                            <br>
                                            <?php while ($data_tampilan=mysqli_fetch_array($tampil_tampilan)){ ?>
                                            <tr>
                                                <td>
                                                <label>Nama Universitas</label>
                                                 <input  class="form-control" type="text" name="univ" size="150"  value="<?php echo $data_tampilan['univ']?>" ></td>
                                            </tr>
                                        </table>
                                            <br>
                                            <textarea id="summernote" name="font" rows="10" cols="80" value="<?php echo $data_tampilan['font'] ?>"></textarea>
                                            <br>
                                            <input type="hidden" name="id" value="<?php echo $data_tampilan['id'] ?>">
                                          <?php }?>
