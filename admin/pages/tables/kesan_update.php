            ...
            <section class="sidebar">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="editors.php"><i class="fa fa-circle-o"></i>Post Kesan</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="../tables/data_kesan.php"><i class="fa fa-circle-o"></i> Data Kesan</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <!-- /.box-header -->
                            <?php $tampil_kesan=mysqli_query($link,"SELECT * FROM tb_kesan  WHERE  id_kesan='$id'"); ?>
                            <div class="box-body pad">
                                <form action="update_kesan.php" method="post" enctype="multipart/form-data">

                                    <table>
                                        <?php while ($data_kesan=mysqli_fetch_array($tampil_kesan)){?>
                                        <tr>
                                            <td>
                                                <label>Nama</label>
                                            <td> <input  class="form-control" type="text" name="nama" size="150" placeholder="Nama" value="<?php echo $data_kesan['nama']?>" ></td>
                                        </tr>
                                        <br>
                                        <tr>
                                            <td>
                                                <label>Jabatan</label>
                                            <td> <input  class="form-control" type="text" name="jabatan" size="150" placeholder="Jabatan" value="<?php echo $data_kesan['jabatan'] ?>" ></td>
                                            </td>
                                        </tr>

                                    </table>
                                    <br>
                                    <textarea id="summernote" name="kesan" rows="10" cols="80" <?php echo $data_kesan['kesan'] ?>></textarea>
                                    <br>
                                        <input type="hidden"  name="id" value="<?php echo $data_kesan['id_kesan'] ?>">
                                    <?php }?>
